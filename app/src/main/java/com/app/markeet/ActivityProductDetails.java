...
public class ActivityProductDetails extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        ic_add_cart = (ImageView) findViewById(R.id.ic_add_cart);
    ...
    private void requestNewsInfoDetailsApi() {
        ...
        callbackCall.enqueue(new Callback<RespProductDetails>() {
            @Override
            public void onResponse(Call<RespProductDetails> call, Response<RespProductDetails> response) {
                RespProductDetails resp = response.body();
            ...
            @Override
            public void onFailure(Call<RespProductDetails> call, Throwable t) {
    ...
    private boolean bounce_badge = false;
    ...
    private void setupBadge() {
        ...
        if (cart_count == 0) {
            ...
            if (bounce_badge) {
                ...
                cart_badge.startAnimation(fade_in);
                bounce_badge = false;
            }
        }
    }
