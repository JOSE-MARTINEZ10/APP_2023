...
public class FragmentFeaturedNews extends Fragment {
    ...
    private Call<RespFeaturedNews> callbackCall;
    ...
    private void requestFeaturedNews() {
        ...
        callbackCall.enqueue(new Callback<RespFeaturedNews>() {
            @Override
            public void onResponse(Call<RespFeaturedNews> call, Response<RespFeaturedNews> response) {
                RespFeaturedNews resp = response.body();
            ...
            @Override
            public void onFailure(Call<RespFeaturedNews> call, Throwable t) {
