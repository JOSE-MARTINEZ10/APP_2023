...
public class ActivityNewsInfoDetails extends AppCompatActivity {
    ...
    private Call<RespNewsInfoDetails> callbackCall = null;
    ...
    private void requestNewsInfoDetailsApi() {
        ...
        callbackCall.enqueue(new Callback<RespNewsInfoDetails>() {
            @Override
            public void onResponse(Call<RespNewsInfoDetails> call, Response<RespNewsInfoDetails> response) {
                RespNewsInfoDetails resp = response.body();
            ...
            @Override
            public void onFailure(Call<RespNewsInfoDetails> call, Throwable t) {
